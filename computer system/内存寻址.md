...
![[computer system/图片/逻辑地址到线性地址的变换过程.png]]
...
![[computer system/图片/段描述符通用格式.png]]
...
![[computer system/图片/代码段、数据段和系统段描述符格式.png]]
...
![[computer system/图片/段描述符表结构.png]]

![[computer system/图片/linux 主要段.png]]
## 分页
...
结构如图所示：
![[computer system/图片/Page_directory_entry.png]]
...
### Page Table entry 
结构如图所示：
![[computer system/图片/Page_table_entry.png]]
...
![[computer system/图片//computer system/图片/多重转换.png]]
...
![[computer system/图片/Virtual_memory.png]]
#### Virtual Memory  虚拟内存
